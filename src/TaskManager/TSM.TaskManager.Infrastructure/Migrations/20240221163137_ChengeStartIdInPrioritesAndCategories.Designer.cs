...
namespace TSM.TaskManager.Infrastructure.Migrations
{
    ...
    [Migration("20240221163137_ChengeStartIdInPrioritesAndCategories")]
    partial class ChengeStartIdInPrioritesAndCategories
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TSM.TaskManager.Domain.Entities.Task", b =>
                {
                    ...
                    b.HasOne("TSM.TaskManager.Domain.Entities.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
